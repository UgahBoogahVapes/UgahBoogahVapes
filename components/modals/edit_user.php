<?php
    function editUserModal($record) {
        echo '
        <div class="modal fade" id="editModal'.$record['id'].'" tabindex="-1" role="dialog" aria-labelledby="editModal'.$record['id'].'Title" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" style="max-width: 40em !important;" role="document">
                <div class="modal-content">
                    ...
                    <form action="./modules/edit.php" method="post" enctype="multipart/form-data">
                        <div id="info">
                            <input type="hidden" name="location" value="manage">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input required class="form-control" name="full_name" type="text" value="'.$record['full_name'].'">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Username</label>
                                                <input required class="form-control" name="username" type="text" value="'.$record['username'].'">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Email</label>
                                                <input required class="form-control" name="email" type="email" value="'.$record['email'].'">
                                            </div>
                                            <div class="form-group">
                                                <label for="example-text-input" class="form-control-label">Type</label>
                                                <select required class="form-control" name="type">
                                                    <option '.($record['type'] == "Employee" ? "selected" : "").' value="employee">Employee</option>
                                                    <option '.($record['type'] == "Supplier" ? "selected" : "").' value="supplier">Supplier</option>
                                                    <option '.($record['type'] == "Admin" ? "selected" : "").' value="admin">Admin</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div style="display: flex; justify-content: end; padding: 0 1em; gap: 0.6em;">
